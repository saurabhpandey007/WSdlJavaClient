...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements org.tempuri.CalculatorService {
    ...
    private java.lang.String BasicHttpBinding_ICalculatorService_address = "http://localhost:65177/Service.svc/CalculatorService";
    ...
    public org.tempuri.ICalculatorService getBasicHttpBinding_ICalculatorService() throws javax.xml.rpc.ServiceException {
    ...
    public org.tempuri.ICalculatorService getBasicHttpBinding_ICalculatorService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.BasicHttpBinding_ICalculatorServiceStub _stub = new org.tempuri.BasicHttpBinding_ICalculatorServiceStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.ICalculatorService.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.BasicHttpBinding_ICalculatorServiceStub _stub = new org.tempuri.BasicHttpBinding_ICalculatorServiceStub(new java.net.URL(BasicHttpBinding_ICalculatorService_address), this);
                _stub.setPortName(getBasicHttpBinding_ICalculatorServiceWSDDServiceName());
                return _stub;
            }
        }
